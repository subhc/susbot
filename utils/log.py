# from https://detectron2.readthedocs.io/en/latest/_modules/detectron2/utils/logger.html
...
def setup_logger(
    ...
    #     abbrev_name = "vgg" if name == LOGGER_PREFIX else name
...
def _find_caller():
    ...
    while frame:
        code = frame.f_code
        if os.path.join("utils", "log") not in code.co_filename:
            mod_name = frame.f_globals["__name__"]
            if mod_name == "__main__":
                mod_name = LOGGER_PREFIX
